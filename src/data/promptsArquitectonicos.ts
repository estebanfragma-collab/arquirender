...
export const iluminacionSketch = ["Soft natural daylight, diffused shadows, global illumination", "Night — warm 2700K pendant lamps, cozy mood", "Side golden hour, long shadows, warm atmosphere", "Dramatic focal lighting, spots on the hero product", "Circular ring LED, signature retail style", "Dawn, soft pink side light"];

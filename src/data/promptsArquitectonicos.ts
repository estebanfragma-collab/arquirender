...
// si cambia su texto, hay que actualizarlo también en src/lib/presets.ts.
export const iluminacionSketch = ["Soft afternoon window daylight casting delicate gradients, cool neutral white balance, no yellow cast", "Warm layered inviting light — cove glow, table lamps switched on, deep blue dusk sky through the glazing, warm 2700K interiors", "Low warm directional sunlight raking from the side, long controlled shadows, warm highlights", "Dramatic focal lighting, strong directional key, deep shadows, illuminated interiors reading through the glass", "Circular ring LED, signature retail style, even product illumination", "Soft diffused daylight filtered through mist, subtle volumetric rays, no yellow cast", "Soft overcast daylight, diffuse shadows, subdued reflections, cool neutral white balance", "Dawn, soft pink side light, cool shadows, low sun just above the horizon"];

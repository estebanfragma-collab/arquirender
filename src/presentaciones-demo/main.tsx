...
function Demo({accountId, history = []}:{accountId?:string;history?:Asset[]}) {
  ...
  return <div className="studio">
    ...
    <fieldset className="editor-controls" disabled={saving||cloudBusy}>
    ...
    <div className="global-status" role="status">{saving?'Guardando presentación e imágenes…':cloudBusy?'Cargando…':notice}</div><footer>ARQUIRENDER · PRESENTACIONES <span>Composición de láminas · sin consumo de créditos</span></footer>
  </div>;
}
